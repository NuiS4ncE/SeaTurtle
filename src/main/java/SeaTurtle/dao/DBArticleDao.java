...
public class DBArticleDao implements ArticleDao<Article, Integer> {
    ...
    @Override
    public String create(Article article) throws SQLException {
        startCon();
        ...
        ResultSet tableKeys = prepstmt.getGeneratedKeys();
        tableKeys.next();
        ...
        return Integer.toString(autoGeneratedID);
    }
    ...
    public ArrayList<Article> list() throws SQLException {
        ...
        ResultSet rs = prepstmt.executeQuery();
        while (rs.next()) {
            articleList.add(new Article(rs.getString("title"), rs.getString("url"), rs.getInt("id")));
        }
        prepstmt.close();
        closeCon();
        return articleList;
